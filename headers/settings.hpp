...
constexpr int WALL_RECTANGLE_QUANTITY = 0;
constexpr int WALL_RECTANGLE_SIZE_MIN = 30;
constexpr int WALL_RECTANGLE_SIZE_MAX = 300;

constexpr int WALL_CIRCLE_QUANTITY = 10;
constexpr int WALL_CIRCLE_RADIUS_MIN = 10;
...
constexpr int PLAYER_SPEED = 350;
constexpr int PLAYER_SCREEN_ROTATION_SENSITIVITY = 100;
constexpr float PLAYER_VIEWING_ANGLE = 60;
